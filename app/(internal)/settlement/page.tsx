...
import { printSettlementReport } from "@/lib/utils/print"
                                ...
                                onClick={() => {
                                  ...
                                  setTimeout(() => {
                                    printSettlementReport(
                                      ...
                                      member,
                                      group,
                                      false, // Historical check usually non-winner or custom
                                      null,
                                      s.final_payout_amount,
                                      s.entries as any[],
                                      balances, // This might be stale if not careful, but usually okay for this view
                                      t
                                    )
                                  }, 100)
                                }}
              ...
              <div className="space-y-6">
                 <div className={cn("p-8 rounded-[2.5rem] border-2 shadow-xl relative overflow-hidden", isWinner ? "bg-blue-600 text-white border-blue-400" : "bg-[var(--surface)] border-[var(--border)]")}>
                    <div className="relative z-10 space-y-8">
                       ...
                       <Btn variant={isWinner ? 'secondary' : 'primary'} className="w-full py-6 rounded-2xl shadow-lg" icon={Printer} 
                         onClick={() => {

-- Migration: 032_add_dividend_from_winner_flag.sql
-- Goal: Add a toggle to control if the winner is excluded from the dividend pool.

-- 1. Add column to groups
ALTER TABLE public.groups 
ADD COLUMN IF NOT EXISTS dividend_from_winner boolean DEFAULT true;

-- 2. Update calculate_auction to respect the flag
...
BEGIN
  ...
  -- 5. Per Member Dividend (Respect the flag)
  IF v_div_from_winner THEN
  ...
  RETURN json_build_object(
    ...
    'dividend_from_winner', v_div_from_winner,

-- Fix Accumulation Scheme Calculation in Collection Workspace
-- Ensure members pay full installment for ACCUMULATION schemes
        ...
        SELECT jsonb_agg(d) FROM (
          SELECT 
            ...
            CASE 
              ...
              ELSE mf.monthly_contribution - COALESCE(a.dividend, 0)
            END as amount_due,
